  ...
  <body>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header text-white" style="background-color: black;">
              <h4 class="modal-title" id="exampleModalLabel">Masukkan data</h4>
            ...
            <div class="modal-body rounded">
              <form action="simpan.php" method="POST">
                ...
                <p><label>Nama Barang : <select name="namabarang" id="nama">
                  <option value="Redmi 8A Pro">Redmi 8A Pro</option>
                ...
                <p><label>Harga : <input type="number" name="harga"></label></p>
    ...
    <script>
      ...
      var totalbelanja_table = []
        ...
        for (let l = 0; l < namabarang_table.length; l++) {

            tampil.innerHTML +='<tr>'+
              '<td scope="col">'+namabarang_table[l]+'</td>'+
              '<td scope="col">'+hargabarang_table[l]+'</td>'+
